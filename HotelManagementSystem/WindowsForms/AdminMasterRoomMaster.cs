...
namespace HotelManagementSystem.WindowsForms
{
    public partial class AdminMasterRoomMaster: Form
    {
        ...
        private void dgvRoomTypes_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvRoomTypes.Columns[e.ColumnIndex].Name == "Activate" && e.RowIndex >= 0)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    {
                        conn.Open();
                        string updateQuery = "UPDATE RoomMaster SET Status = 'Active' WHERE RoomType = @RoomType";
        ...
        private void LoadUnderMaintenanceRoomTypes()
        {
            ...
            {
                conn.Open();
                string query = "SELECT  RoomType, RoomNo, Status FROM RoomMaster WHERE Status = 'UnderMaintenance'";
        ...
        private void AdminMasterRoomMaster_Load(object sender, EventArgs e)
        {
